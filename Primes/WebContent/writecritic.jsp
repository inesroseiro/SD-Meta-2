...
<s:div cssClass="limiter">
	<s:div cssClass="container-login100">
		<s:div cssClass = "wrap-login100">
			...
			<s:form action="writecritic" method="post">
				<s:textfield cssClass = "insert100" name = "artistname" placeholder="Artist Name" required="true" />
				<s:div id="centering">
					<p></p>
				</s:div>
				...
				<s:textfield cssClass = "insert100" name = "rate" placeholder="Rating (0-5)" required="true" />
				<s:div id="centering">
					<p></p>
				</s:div>
				<s:textfield cssClass = "insert100" name = "critic" placeholder="Critic" required="true" />
				<s:div id="centering3">
					<p></p>
				</s:div>
