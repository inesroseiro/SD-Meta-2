	...
	<s:div cssClass="container-login100">
		<s:div cssClass = "wrap-login100">
			...
			<s:form action="editalbum" method="post">
				...
				<s:textfield cssClass = "insert100" name = "oldname" placeholder="OLD Album Name" required="true" />
				<s:div id="centering">
					<p></p>
				</s:div>
				<s:textfield cssClass = "insert100" name = "name" placeholder="NEW Album Name" required="true" />
				<s:div id="centering">
					<p></p>
				</s:div>
				<s:textfield cssClass = "insert100" name = "description" placeholder="NEW Album Description" required="true" />
				<s:div id="centering">
					<p></p>
				</s:div>
				<s:textfield cssClass = "insert100" name = "genre" placeholder="NEW Musical Genre" required="true" />
				<s:div id="centering">
					<p></p>
				</s:div>
