        ...
        <s:div cssClass = "wrap-login100">
            ...
            <s:form action="login" method="post">
                <s:div cssClass="container-login100-form-btn">
                        <a href="insertartist.jsp" class="selectVal">Insert Artist</a>
                    <s:div id="centering2">
                        <p></p>
                    </s:div>
                        <a href="removeartist.jsp" class="selectVal">Remove Artist</a>
                    <s:div id="centering2">
                        <p></p>
                    </s:div>
                        <a href="editartist.jsp" class="selectVal">Edit Artist</a>
                    <s:div id="centering2">
                        <p></p>
                    </s:div>
                    ...
                    <s:div id="centering2">
                        ...
                        <a href="viewArtistDetailsEditor.jsp" class="selectVal">View Details</a>
