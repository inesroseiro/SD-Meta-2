        ...
        <s:div cssClass = "wrap-login100">
            ...
            <s:form action="login" method="post">
                <s:div cssClass="container-login100-form-btn">
                        <a href="insertmusic.jsp" class="selectVal">Insert Music</a>
                    <s:div id="centering2">
                        <p></p>
                    </s:div>
                        <a href="removemusic.jsp" class="selectVal">Remove Music</a>
                    <s:div id="centering2">
                        <p></p>
                    </s:div>
                        <a href="editmusic.jsp" class="selectVal">Edit Music</a>
                    <s:div id="centering2">
                        <p></p>
                    </s:div>
                        <a href="viewMusicDetailsEditor.jsp" class="selectVal">View Details</a>
