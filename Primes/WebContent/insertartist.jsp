...
<s:div cssClass="limiter">
	<s:div cssClass="container-login100">
		<s:div cssClass = "wrap-login100">
			...
			<s:form action="insertartist" method="post">
				<s:textfield cssClass="insert100" name = "name" placeholder="Artist Name" required="true" />
				<s:div id="centering">
					<p></p>
				</s:div>
				<s:textfield cssClass = "insert100" name = "description" placeholder="Artist Description" required="true" />
				<s:div id="centering3">
					<p></p>
				</s:div>
