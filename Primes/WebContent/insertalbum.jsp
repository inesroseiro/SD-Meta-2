...
<s:div cssClass="limiter">
	<s:div cssClass="container-login100">
		<s:div cssClass = "wrap-login100">
			...
			<s:form action="insertalbum" method="post">
				<s:textfield cssClass="insert100" name = "name" placeholder="Album Name" required="true" />
				<s:div id="centering">
					<p></p>
				</s:div>
				<s:textfield cssClass = "insert100" name = "description" placeholder="Album Description" required="true" />
				<s:div id="centering">
					<p></p>
				</s:div>
				<s:textfield cssClass = "insert100" name = "genre" placeholder="Musical Genre" required="true" />
				<s:div id="centering">
					<p></p>
				</s:div>
